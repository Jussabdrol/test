...
| Operational planning | `tasks.js`, `task-instances.js`, `actions.js`, `plan-bundles.js` | `operations/layout.js` (filter disclosures), `operations/yearly-plan.js` (planning tabs), `operations/workspace.js` (control tickets and follow-ups), `operations/tasks.js`, `operations/actions.js`, `dashboard.js` |
