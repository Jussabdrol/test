> Historical validation record from before the repository restructuring. File and branch references below describe that earlier change. For current paths and checks, use [the architecture guide](../architecture.md) and [development guide](../development.md).
